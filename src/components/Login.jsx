    ...
    if(username!=="" && password!==""){
      dispatch(loginuser(username,password)).then((res)=>{
       console.log("login",res)
        if(res.data.message==="Invalid email, please register first"){
          toast({
...
<Flex justifyContent={'center'}  paddingTop={'10px'}> <Text as={'h5'}>New User {" "}</Text><Link to="/"><Text color={'pink.600'} fontWeight={'bold'}>Register Now</Text></Link></Flex>
