...
export default function JoinOurTeam() {
  ...
  const handleSubmit=()=>{
    if(firstname!=="", lastname!=="",email!=="" && password!=="" ){
      dispatch(postuser(firstname,lastname,email,password)).then((res)=>{
       console.log("register",res)
        if(res.message=="email already exists"){
          toast({
            title: "email already exists, Kindly login" ,
...
<Flex justifyContent={'center'}paddingRight={'2px'}  paddingTop={'10px'}> <Text as={'h5'}>Already Our member </Text><Link to="/login"><Text color={'pink.600'} fontWeight={'bold'}>Login Now</Text></Link></Flex>
